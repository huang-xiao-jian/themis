...
export const EditBooleanSwitchCase = createEditCase(BOOLEAN_SWITCH, {
  id: 'r-1',
  name: 'is_active',
  operator: 'is',
  threshold: true,
...
export const EditStringTextInputCase = createEditCase(STRING_INPUT, {
  id: 'r-2',
  name: 'username',
  operator: 'contains',
  threshold: 'admin',
...
export const EditStringTextAreaCase = createEditCase(STRING_TEXTAREA, {
  id: 'r-3',
  name: 'description',
  operator: '=',
...
export const EditNumberInputCase = createEditCase(NUMBER_INPUT, {
  id: 'r-4',
  name: 'age',
  operator: '>=',
  threshold: 18,
...
export const EditStringListBuilderCase = createEditCase(STRING_LIST, {
  id: 'r-5',
  name: 'tags',
  operator: 'in',
...
export const EditNumberListBuilderCase = createEditCase(NUMBER_LIST, {
  id: 'r-6',
  name: 'allowed_levels',
  operator: 'in',
  threshold: [1, 3, 5],
...
export const EditNumberRangeCase = createEditCase(NUMBER_RANGE, {
  id: 'r-7',
  name: 'order_amount',
  operator: 'between',
  threshold: [100, 5000],
...
export const EditNumberRangeListCase = createEditCase(NUMBER_RANGE_LIST, {
  id: 'r-8',
  name: 'price_ranges',
...
export const EditDatePickerCase = createEditCase(DATE_PICKER, {
  id: 'r-9',
  name: 'start_date',
  operator: '=',
...
export const EditDatePickerListCase = createEditCase(DATE_PICKER_LIST, {
  id: 'r-10',
  name: 'holidays',
  operator: 'in',
...
export const EditDateRangePickerCase = createEditCase(DATE_RANGE_PICKER, {
  id: 'r-11',
  name: 'visit_date_range',
  operator: 'between',
  threshold: [1717372800000, 1719964800000],
...
export const EditDateRangeListCase = createEditCase(DATE_RANGE_LIST, {
  id: 'r-12',
  name: 'blackout_periods',
  operator: 'between any',
  threshold: [
...
export const EditStaticSelectCase = createEditCase(STATIC_SELECT, {
  id: 'r-13',
  name: 'deliver_city',
  operator: '=',
  threshold: 'sh',
...
export const EditStaticMultipleSelectCase = createEditCase(STATIC_MULTIPLE_SELECT, {
  id: 'r-14',
  name: 'target_cities',
  operator: 'in',
  threshold: ['bj', 'sh', 'gz'],
...
export const EditDynamicSelectCase = createEditCase(DYNAMIC_SELECT, {
  id: 'r-15',
  name: 'employee',
  operator: '=',
  threshold: 'emp-001',
...
export const EditDynamicMultipleSelectCase = createEditCase(DYNAMIC_MULTIPLE_SELECT, {
  id: 'r-16',
  name: 'employee_list',
  operator: 'in',
